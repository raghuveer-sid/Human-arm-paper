...
%To stretch the cylinder to a particular length, take in an argument 'length', and change line 44 to:
% z = (0:m-1)'/(m-1) * ones(1,n+1) * length;
%  with R taken as [0 1], the code returns a cone with radius 1 at height 1.
